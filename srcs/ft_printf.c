...
/*   Updated: 2020/08/04 19:49:37 by hyuki            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		set_tmp(t_printf *p_t)
{
	if (p_t->conversion == 'c')
		...
		return (set_uxX(va_arg(p_t->ap, unsigned int), 'u', p_t));
	else if (p_t->conversion == 'x')
		return (set_uxX(va_arg(p_t->ap, unsigned int), 'x', p_t));
	else if (p_t->conversion == 'X')
		return (set_uxX(va_arg(p_t->ap, unsigned int), 'X', p_t));
